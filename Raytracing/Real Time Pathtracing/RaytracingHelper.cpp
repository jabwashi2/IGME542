...
// --------------------------------------------------------
Mesh::MeshRaytracingData RaytracingHelper::CreateBottomLevelAccelerationStructureForMesh(Mesh* mesh)
{
	...
	vertexSRVDesc.Buffer.NumElements = (mesh->GetIndexCount() * sizeof(Vertex)) / sizeof(float); // How many floats total?
